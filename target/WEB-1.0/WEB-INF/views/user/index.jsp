	...
	<div class="row">
		<div id="sidebar" class="span3">
			<div class="well well-small">
				<ul class="nav nav-list">
					...
					<li><a class="totalInCart" href="<c:url value = "/listCart"/>"><strong>Tổng
								...
								style="line-height: 18px;">${ totalPrice }đ</span>
						</strong></a></li>
				</ul>
			</div>
			...
			<ul class="nav nav-list promowrapper">
				<li>
					<div class="thumbnail">
						<a class="zoomTool" href="<c:url value="/product_detail/${ item.id_product }"/>" title="add to cart"><span
				...
				<li>
					<div class="thumbnail">
						<a class="zoomTool" href="product_details" title="add to cart"><span
							class="icon-search"></span> QUICK VIEW</a> <img
							src="<c:url value="/assets/user/img/bootstrap-template.png"/>"
					...
					<c:if test="${ products.size() > 0 }">
						<div class="item active">
							...
							<c:forEach var="item" items="${ products }" varStatus="loop">
								<li class="span3">
									<div class="thumbnail">
										<a class="zoomTool" href="<c:url value="/product_detail/${ item.id_product }"/>"
											title="add to cart"><span class="icon-search"></span>
											QUICK VIEW</a> <a href="<c:url value="/product_detail/${ item.id_product }"/>"><img
											src="<c:url value="/assets/user/img/sanpham/${ item.image }"/>" alt=""></a>
									</div>
								</li>
						...
						<li class="span4">
							<div class="thumbnail">
								<a class="zoomTool" href="<c:url value="/product_detail/${ item.id_product }"/>"
									...
									VIEW</a> <a href="product_detail/${ item.id_product }"><img
									src="<c:url value="/assets/user/img/sanpham/${ item.image }"/>"
									alt=""></a>
								<div class="caption">
									<h5>${ item.product_name }</h5>
									<h4>
										<a class="defaultBtn" href="<c:url value="/product_detail/${ item.id_product }"/>"
